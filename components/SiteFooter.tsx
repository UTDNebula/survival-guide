        ...
        <footer className="p-4 bg-white bg-Neutral-50 border-2 border-slate-200 text-black">
            <div className='container w-9/12 mx-auto'>
                <div className="grid grid-cols-3 gap-0 divide-x divide-slate-400">
                    <img
                        className = "w-30 h-20 self-center	"
                        src = {logo2.src}
                        alt = 'Nebula logo'
                    />
                    ...
                    <div className='pl-10 pr-0'>
                        ...
                        <ul className="">
                            <li>
                                <p className='text-sm'>Survival Guide is published by Nebula Labs, a registered student organization at The University of Texas at Dallas. The UTD Survival Guide is not an official publication of UT Dallas and does not represent the views of the university or its officers.</p>
                            </li>
                        </ul>
                    </div>
                </div>
